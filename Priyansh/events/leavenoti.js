...
  (typeof data.customLeave == "undefined") ? msg = "💖💖😍☞𝐑𝐢𝐘𝐚 𝐑𝐨𝐘☜😍💖💖✧═════════•❁❀❁•═════════✧           💖   💖 ✧═════════•❁❀❁•═════════✧   💝🥀𝐎𝐖𝐍𝐄𝐑 :-  ☞💖👑 ℝ𝕀𝕐𝔸 ℝ𝕆𝕐 👑💖☜ ✧═════════•❁❀❁•═════════✧   💝🥀𝐎𝐖𝐍𝐄𝐑 :-☞💖👑 𝗞𝗔𝗕𝗨𝗧𝗥𝗜 👑💖☜ ✧═════════•❁❀❁•═════════✧    ☞︎𝚂𝚄𝙺𝙰𝚁 𝙷𝙰𝙸 𝙴𝙺 𝚃𝙷𝙰𝚁𝙺𝙸 𝙴𝚂 𝙶𝚁𝙾𝚄𝙿 𝙼𝙴 𝙺𝙼 𝙷𝙾 𝙶𝙰𝚈𝙰🤪🤪🤪☜︎
✧═════════•❁❀❁•═════════✧   💖 𝗡𝗔𝗠𝗘÷  ☞︎[  {name} ]☜︎🤭
✧═════════•❁❀❁•═════════✧   💖𝗥𝗜𝗝𝗔𝗡÷ ☞︎[  {type} ]☜︎😁😁 ✧═════════•❁❀❁•═════════✧ फेसबुक 🆔 :- 👇 https://www.facebook.com/yi.riya.roya.apane.lav?mibextid=ZbWKwL ✧═════════•❁❀❁•═════════✧ किसी भी तरह की हेल्प के लिए कांटेक्ट करे 👉 [+91 🤭🤭🤭🤭🤭]" : msg = data.customLeave;
	msg = msg.replace(/\{name}/g, name).replace(/\{type}/g, type);
  
  var link = [  
"https://i.imgur.com/2hr28Gw.jpg",
"https://i.imgur.com/9X4LTnz.jpeg",
"https://i.imgur.com/WR0gD5i.jpeg",
"https://i.imgur.com/BmEQuLI.jpeg",
  ];
